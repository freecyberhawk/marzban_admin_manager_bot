...
from dep import xray
from dep.db import GetDB, crud
from dep.models.proxy import ProxyTypes
from dep.models.user import (
    UserCreate,
    UserModify,
    UserResponse,
    UserStatus,
...
from dep.models.user_template import UserTemplateResponse
# from dep.telegram import bot
from dep.utils.custom_filters import cb_query_equals, cb_query_startswith
from dep.utils.keyboard import BotKeyboard
from dep.utils.shared import (
    get_number_at_end,
...
from dep.utils.store import MemoryStorage
from dep.utils.system import cpu_usage, memory_usage, readable_size, realtime_bandwidth
...
<b>Add template <u>Data limit</u> and <u>Time</u> to user or Reset to <u>Template default</u></b>⁉️""",
        ...
        elif (not user.data_limit and not user.expire) or (user.used_traffic > user.data_limit) or (
                now > datetime.fromtimestamp(user.expire)):

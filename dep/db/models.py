...
from dep.db.base import Base
from dep.models.node import NodeStatus
from dep.models.proxy import (
    ProxyHostALPN,
    ProxyHostFingerprint,
    ProxyHostSecurity,
    ProxyTypes,
)
from dep.models.user import ReminderType, UserDataLimitResetStrategy, UserStatus
...
class Admin(Base):
    ...
    payments = relationship("Payment", back_populates="admin", cascade="all, delete-orphan")
    hakobot_balance = Column(BigInteger, nullable=False, default=0)
    hakobot_gb_fee = Column(BigInteger, nullable=False, default=2000)
